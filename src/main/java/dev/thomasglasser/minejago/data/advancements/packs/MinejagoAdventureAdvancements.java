...
public class MinejagoAdventureAdvancements extends ExtendedAdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider provider) {
        ...
        AdvancementHolder interactWithMainSix = create(ResourceLocation.withDefaultNamespace("adventure/root"), MinejagoItems.BAMBOO_STAFF.get(), "interact_with_main_six", AdvancementType.GOAL, true, true, false, null, AdvancementRequirements.Strategy.AND, Map.of(
                "interact_wu", PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(ItemPredicate.Builder.item(), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of(entities, MinejagoEntityTypes.WU.get()).build()))),
                "interact_nya", PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(ItemPredicate.Builder.item(), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of(entities, MinejagoEntityTypes.NYA.get()).build()))),
                "interact_jay", PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(ItemPredicate.Builder.item(), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of(entities, MinejagoEntityTypes.JAY.get()).build()))),
                "interact_kai", PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(ItemPredicate.Builder.item(), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of(entities, MinejagoEntityTypes.KAI.get()).build()))),
                "interact_cole", PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(ItemPredicate.Builder.item(), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of(entities, MinejagoEntityTypes.COLE.get()).build()))),
                "interact_zane", PlayerInteractTrigger.TriggerInstance.itemUsedOnEntity(ItemPredicate.Builder.item(), Optional.of(EntityPredicate.wrap(EntityPredicate.Builder.entity().of(entities, MinejagoEntityTypes.ZANE.get()).build())))), "Meet N' Greet", "Interact with Wu, Nya, and the Four Ninja");
        ...
        AdvancementHolder killSamukai = create(startSkulkinRaid, MinejagoArmors.SAMUKAIS_CHESTPLATE.get(), "kill_samukai", AdvancementType.CHALLENGE, true, true, false, AdvancementRewards.Builder.experience(10).build(),
                "kill_samukai", KilledTrigger.TriggerInstance.playerKilledEntity(EntityPredicate.Builder.entity().of(entities, MinejagoEntityTypes.SAMUKAI.get())), "Knives Out", "Defeat Samukai");
        ...
        AdvancementHolder collectAllSkeletalChestplates = create(killASkulkin, MinejagoArmors.SKELETAL_CHESTPLATE_SET.getForVariant(Skulkin.Variant.STRENGTH).get(), "collect_all_skeletal_chestplates", AdvancementType.CHALLENGE, true, true, false, AdvancementRewards.Builder.experience(25).build(), AdvancementRequirements.Strategy.AND, Map.of(
                "collect_strength", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(items, MinejagoArmors.SKELETAL_CHESTPLATE_SET.getForVariant(Skulkin.Variant.STRENGTH).get()).build()),
                "collect_speed", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(items, MinejagoArmors.SKELETAL_CHESTPLATE_SET.getForVariant(Skulkin.Variant.SPEED).get()).build()),
                "collect_bow", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(items, MinejagoArmors.SKELETAL_CHESTPLATE_SET.getForVariant(Skulkin.Variant.BOW).get()).build()),
                "collect_knife", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(items, MinejagoArmors.SKELETAL_CHESTPLATE_SET.getForVariant(Skulkin.Variant.KNIFE).get()).build())), "It's Always You Four Colors", "Collect all of the Skeletal Chestplate variants");
        ...
        AdvancementHolder getTeapot = create(ResourceLocation.withDefaultNamespace("adventure/root"), MinejagoBlocks.TEAPOT.get(), "get_teapot", AdvancementType.TASK, true, true, false, null,
                "get_teapot", InventoryChangeTrigger.TriggerInstance.hasItems(ItemPredicate.Builder.item().of(items, MinejagoItemTags.TEAPOTS).build()), "Something is brewing...", "Acquire a teapot");
