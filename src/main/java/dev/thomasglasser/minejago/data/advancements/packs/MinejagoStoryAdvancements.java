...
public class MinejagoStoryAdvancements extends ExtendedAdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries) {
        AdvancementHolder root = root(MinejagoItems.SCYTHE_OF_QUAKES.get(), "root", ResourceLocation.withDefaultNamespace("textures/gui/advancements/backgrounds/stone.png"), AdvancementType.TASK, false, false, false, null, Map.of(
        ...
        AdvancementHolder getBlackGi = create(root, MinejagoArmors.BLACK_GI_SET.HEAD.get(), "get_black_gi", AdvancementType.TASK, true, true, false, null, Map.of(
        ...
        AdvancementHolder doSpinjitzu = create(getBlackGi, PotionContents.createItemStack(MinejagoItems.FILLED_TEACUP.get(), MinejagoPotions.OAK_TEA.asReferenceFrom(registries)), "do_spinjitzu", AdvancementType.TASK, true, true, false, null, Map.of(
                "do_spinjitzu", DidSpinjitzuTrigger.TriggerInstance.didSpinjitzu()), "Twistitzu? Tornadzu?", "Do spinjitzu for the first time");

        AdvancementHolder getFourWeaponsMap = create(getBlackGi, Items.FILLED_MAP, "get_four_weapons_map", AdvancementType.TASK, true, true, false, null, Map.of(
        ...
        AdvancementHolder getPower = create(getFourWeaponsMap, fireHead, "get_power", AdvancementType.TASK, true, true, false, null, Map.of(
                "get_power", GotPowerTrigger.TriggerInstance.gotPower()), "I've Got the Power!", "Discover your elemental power");

        AdvancementHolder enterGoldenWeaponsStructure = create(getPower, MinejagoItems.SCYTHE_OF_QUAKES.get(), "enter_golden_weapons_structure", AdvancementType.TASK, true, true, false, null, Map.of(
        ...
        AdvancementHolder tameDragon = create(enterGoldenWeaponsStructure, Items.SADDLE, "tame_dragon", AdvancementType.CHALLENGE, true, true, false, AdvancementRewards.Builder.experience(15).build(), Map.of(
