...
public class GiEntry extends IndexModeEntryProvider {
    ...
    protected void generatePages() {
        ...
        page("black", () -> BookImagePageModel.create()
                .withAnchor("black")
                .withImages(WikiBookSubProvider.wikiTexture("elements/gi/black.png"))
                .withTitle(context().pageTitle())
                .withText(context().pageText()));
        ...
        add(context().pageText(), """
                ...
                It is not associated with any element and is given by [Wu](entry://characters/ninja_team@wu) when training begins.
                """);

        page("training", () -> BookImagePageModel.create()
                .withAnchor("training")
                .withImages(WikiBookSubProvider.wikiTexture("elements/gi/training.png"))
                .withTitle(context().pageTitle())
                .withText(context().pageText()));

        add(context().pageTitle(), "Training Gi");
        add(context().pageText(), """
                The Training Gi is the first Gi you will receive after discovering your elemental element.
        ...
        page("creative_mode_tab", () -> BookImagePageModel.create()
                ...
                .withImages(WikiBookSubProvider.wikiTexture("elements/gi/creative_mode_tab.png"))
                .withTitle(context().pageTitle())
                .withText(context().pageText()));
