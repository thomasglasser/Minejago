...
public class MinejagoBannerPatternTags extends BannerPatternTagsProvider {
    public static final TagKey<BannerPattern> PATTERN_ITEM_FOUR_WEAPONS = TagKey.create(Registry.BANNER_PATTERN_REGISTRY, new ResourceLocation(MinejagoMod.MODID, "pattern_item/four_weapons"));

    public MinejagoBannerPatternTags(DataGenerator p_236411_, @Nullable ExistingFileHelper existingFileHelper) {
        super(p_236411_, MinejagoMod.MODID, existingFileHelper);
    }
