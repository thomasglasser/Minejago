...
public class Zane extends Character {
    ...
    public Zane(EntityType<? extends Zane> entityType, Level level) {
        ...
        new ElementData(Elements.ICE, true).save(this, false);
    ...
    public static boolean checkZaneSpawnRules(EntityType<Zane> animal, LevelAccessor level, MobSpawnType spawnReason, BlockPos pos, RandomSource random) {
