...
public class LongDistanceRaiderPatrol<T extends MeleeCompatibleSkeletonRaider> extends ExtendedBehaviour<T>
{
	...
	public LongDistanceRaiderPatrol()
	{
		cooldownProvider = entity -> 200;
	}

	public LongDistanceRaiderPatrol<T> speedModifier(float speedMod)
	{
	...
	public LongDistanceRaiderPatrol<T> leaderSpeedModifier(float speedMod)
	{
