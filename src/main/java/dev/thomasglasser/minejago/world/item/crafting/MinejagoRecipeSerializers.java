...
public class MinejagoRecipeSerializers {
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<TeapotBrewingRecipe>> TEAPOT_BREWING_RECIPE = register("teapot_brewing", TeapotBrewingRecipe.Factory::new);
