...
{
    public static final DeferredRegister<Item> ARMOR = DeferredRegister.create(ForgeRegistries.ITEMS, Minejago.MOD_ID);
    public static final List<ArmorSet> SETS = new ArrayList<>();
    public static final List<PoweredArmorSet> POWERED_SETS = new ArrayList<>();

    private static final Item.Properties DEFAULT_PROPERTIES = new Item.Properties().stacksTo(1).setNoRepair();
