...
public class MinejagoItems {
    ...
    public static final DeferredItem<ThrowableSwordItem> BONE_KNIFE = register("bone_knife", properties -> new ThrowableSwordItem(MinejagoEntityTypes.THROWN_BONE_KNIFE::value, MinejagoSoundEvents.BONE_KNIFE_THROW, MinejagoSoundEvents.BONE_KNIFE_IMPACT, MinejagoToolMaterials.BONE, 2.5F, -0.4F, properties.rarity(Rarity.UNCOMMON)), List.of(CreativeModeTabs.COMBAT));
    public static final DeferredItem<ScytheOfQuakesItem> SCYTHE_OF_QUAKES = register("scythe_of_quakes", ScytheOfQuakesItem::new, List.of(CreativeModeTabs.COMBAT, CreativeModeTabs.TOOLS_AND_UTILITIES));
    public static final DeferredItem<TeacupItem> TEACUP = register("teacup", TeacupItem::new, List.of(CreativeModeTabs.INGREDIENTS));
    public static final DeferredItem<FilledTeacupItem> FILLED_TEACUP = register("filled_teacup", properties -> new FilledTeacupItem(properties.stacksTo(1).component(DataComponents.POTION_CONTENTS, PotionContents.EMPTY).component(DataComponents.CONSUMABLE, Consumables.DEFAULT_DRINK).usingConvertsTo(TEACUP.get())), List.of());
    public static final DeferredItem<Item> SCROLL = register("scroll", Item::new, List.of(CreativeModeTabs.INGREDIENTS));
    public static final DeferredItem<WritableScrollItem> WRITABLE_SCROLL = register("writable_scroll", properties -> new WritableScrollItem(properties.stacksTo(1).component(DataComponents.WRITABLE_BOOK_CONTENT, WritableBookContent.EMPTY)), List.of(CreativeModeTabs.TOOLS_AND_UTILITIES));
    public static final DeferredItem<WrittenScrollItem> WRITTEN_SCROLL = register("written_scroll", properties -> new WrittenScrollItem(properties.stacksTo(16).component(DataComponents.ENCHANTMENT_GLINT_OVERRIDE, true)), List.of());
    ...
    public static final DeferredItem<SpinjitzuCourseElementItem> CENTER_SPINJITZU_COURSE_ELEMENT = register("center_spinjitzu_course_element", properties -> new SpinjitzuCourseElementItem(MinejagoEntityTypes.CENTER_SPINJITZU_COURSE_ELEMENT::get, properties), List.of(CreativeModeTabs.REDSTONE_BLOCKS));
    public static final DeferredItem<SpinjitzuCourseElementItem> BOUNCING_POLE_SPINJITZU_COURSE_ELEMENT = register("bouncing_pole_spinjitzu_course_element", properties -> new SpinjitzuCourseElementItem(MinejagoEntityTypes.BOUNCING_POLE_SPINJITZU_COURSE_ELEMENT::get, properties), List.of(CreativeModeTabs.REDSTONE_BLOCKS));
    public static final DeferredItem<SpinjitzuCourseElementItem> ROCKING_POLE_SPINJITZU_COURSE_ELEMENT = register("rocking_pole_spinjitzu_course_element", properties -> new SpinjitzuCourseElementItem(MinejagoEntityTypes.ROCKING_POLE_SPINJITZU_COURSE_ELEMENT::get, properties), List.of(CreativeModeTabs.REDSTONE_BLOCKS));
    public static final DeferredItem<SpinjitzuCourseElementItem> SPINNING_POLE_SPINJITZU_COURSE_ELEMENT = register("spinning_pole_spinjitzu_course_element", properties -> new SpinjitzuCourseElementItem(MinejagoEntityTypes.SPINNING_POLE_SPINJITZU_COURSE_ELEMENT::get, properties), List.of(CreativeModeTabs.REDSTONE_BLOCKS));
    public static final DeferredItem<SpinjitzuCourseElementItem> SPINNING_MACES_SPINJITZU_COURSE_ELEMENT = register("spinning_maces_spinjitzu_course_element", properties -> new SpinjitzuCourseElementItem(MinejagoEntityTypes.SPINNING_MACES_SPINJITZU_COURSE_ELEMENT::get, properties), List.of(CreativeModeTabs.REDSTONE_BLOCKS));
    public static final DeferredItem<SpinjitzuCourseElementItem> SPINNING_DUMMIES_SPINJITZU_COURSE_ELEMENT = register("spinning_dummies_spinjitzu_course_element", properties -> new SpinjitzuCourseElementItem(MinejagoEntityTypes.SPINNING_DUMMIES_SPINJITZU_COURSE_ELEMENT::get, properties), List.of(CreativeModeTabs.REDSTONE_BLOCKS));
    public static final DeferredItem<SpinjitzuCourseElementItem> SWIRLING_KNIVES_SPINJITZU_COURSE_ELEMENT = register("swirling_knives_spinjitzu_course_element", properties -> new SpinjitzuCourseElementItem(MinejagoEntityTypes.SWIRLING_KNIVES_SPINJITZU_COURSE_ELEMENT::get, properties), List.of(CreativeModeTabs.REDSTONE_BLOCKS));
    public static final DeferredItem<SpinjitzuCourseElementItem> SPINNING_AXES_SPINJITZU_COURSE_ELEMENT = register("spinning_axes_spinjitzu_course_element", properties -> new SpinjitzuCourseElementItem(MinejagoEntityTypes.SPINNING_AXES_SPINJITZU_COURSE_ELEMENT::get, properties), List.of(CreativeModeTabs.REDSTONE_BLOCKS));

    public static void init() {}

    public static <T extends Item> DeferredItem<T> register(String name, Function<Item.Properties, T> itemFunction, List<ResourceKey<CreativeModeTab>> tabs) {
        return ItemUtils.register(ITEMS, name, itemFunction, tabs);
    }
