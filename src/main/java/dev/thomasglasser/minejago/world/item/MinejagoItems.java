...
public class MinejagoItems
{
    ...
    public static final RegistryObject<Item> LEGEND_SCROLL = ITEMS.register("legend_scroll", () -> new LegendScrollItem(new Item.Properties().tab(CreativeModeTab.TAB_MISC).rarity(Rarity.EPIC).stacksTo(1)));
