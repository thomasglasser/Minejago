...
import dev.thomasglasser.minejago.world.level.storage.ProgressData;
...
public class MinejagoAttachmentTypes {
    ...
    public static final DeferredHolder<AttachmentType<?>, AttachmentType<ProgressData>> PROGRESS = ATTACHMENT_TYPES.register("progress", () -> AttachmentType.builder(ProgressData::new).serialize(ProgressData.CODEC).build());
