...
public class SkillScreen extends Screen {
    ...
    public void render(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        guiGraphics.blit(RenderType::guiTextured, Skill.AGILITY.getIcon(), width / 2 - 61, height / 2 - 46, 0, 0, 32, 39, 32, 39);
        ...
        guiGraphics.blit(RenderType::guiTextured, Skill.STEALTH.getIcon(), width / 2 + 6, height / 2 - 46, 0, 0, 32, 39, 32, 39);
        ...
        guiGraphics.blit(RenderType::guiTextured, Skill.DEXTERITY.getIcon(), width / 2 - 61, height / 2 + 12, 0, 0, 32, 39, 32, 39);
        ...
        guiGraphics.blit(RenderType::guiTextured, Skill.TOOL_PROFICIENCY.getIcon(), width / 2 + 7, height / 2 + 12, 0, 0, 32, 39, 32, 39);
