...
public class KrunchaModel<S extends Skeleton> extends HumanoidModel<S> {
    ...
    @Override
    public void setupAnim(S entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
