...
public class MinejagoDataComponents {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<ResourceKey<Element>>> ELEMENT = register("element", ResourceKey.codec(MinejagoRegistries.ELEMENT), ResourceKey.streamCodec(MinejagoRegistries.ELEMENT), false);
