...
public class MinejagoTreeFeatures
{
	...
	public static void bootstrap(BootstapContext<ConfiguredFeature<?, ?>> pContext) {
		registerTreeSet(pContext, MinejagoBlocks.FOCUS_WOOD.log(), MinejagoBlocks.FOCUS_WOOD.leaves(), FOCUS, FANCY_FOCUS, FOCUS_BEES_0002, FOCUS_BEES_002, FOCUS_BEES_005, FANCY_FOCUS_BEES_0002, FANCY_FOCUS_BEES_002, FANCY_FOCUS_BEES_005, FANCY_FOCUS_BEES);
	}
