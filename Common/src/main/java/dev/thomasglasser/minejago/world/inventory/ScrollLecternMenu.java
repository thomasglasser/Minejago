...
public class ScrollLecternMenu extends AbstractContainerMenu {
    ...
    public ScrollLecternMenu(int pContainerId) {
        this(pContainerId, new SimpleContainer(1), new SimpleContainerData(1));
    }

    public ScrollLecternMenu(int pContainerId, Container pLectern, ContainerData pLecternData) {
        super(MinejagoMenuTypes.SCROLL_LECTERN.get(), pContainerId);
