...
public class FocusConstants
{
	...
	public static final int TICK_COUNT = 80;
	public static final int TAME_LEVEL = 18;
	public static final int TALK_LEVEL = 10;
	public static final int DOING_SPINJITZU_LEVEL = 6;
	public static final int LEARNING_SPINJITZU_LEVEL = 6; // TODO: Add where learn
	public static final int USING_GOLDEN_WEAPON_LEVEL = 4;
	...
	public static final float EXHAUSTION_TAME = 6.0F;
	public static final float EXHAUSTION_DOING_SPINJITZU = 0.1F;
	public static final float EXHAUSTION_INSOMNIA = 1.0F;
	public static final float EXHAUSTION_LEARNING_SPINJITZU = 2.5F; // TODO: Add where learn
	public static final float EXHAUSTION_USING_GOLDEN_WEAPON = 2.0F;
}
