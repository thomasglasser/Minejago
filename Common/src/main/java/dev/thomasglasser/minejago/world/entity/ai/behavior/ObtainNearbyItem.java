...
public class ObtainNearbyItem<T extends MeleeCompatibleSkeletonRaider> extends ExtendedBehaviour<T>
{
	...
	public ObtainNearbyItem(Predicate<ItemEntity> entityPredicate, Predicate<ItemStack> stackPredicate)
	{
