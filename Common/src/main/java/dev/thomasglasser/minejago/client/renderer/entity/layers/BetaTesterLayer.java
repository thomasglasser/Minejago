...
public class BetaTesterLayer<T extends LivingEntity> extends RenderLayer<T, PlayerModel<T>> {
    private static final ResourceLocation BAMBOO_HAT_TEXTURE = Minejago.modLoc("textures/entity/player/bamboo_hat.png");
    private static final ResourceLocation HOLIDAY_HAT_TEXTURE = Minejago.modLoc("textures/entity/player/holiday_hat.png");
