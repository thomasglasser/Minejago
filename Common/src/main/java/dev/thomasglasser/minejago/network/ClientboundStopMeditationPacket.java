    ...
    public void handle() {
        ...
        if (Minejago.Dependencies.PLAYER_ANIMATOR.isInstalled())
        {
            if (fail)
                ...
                MinejagoAnimationUtils.startAnimation(PlayerAnimations.Meditation.FINISH.getAnimation(), null, MinejagoClientUtils.getClientPlayerByUUID(uuid), FirstPersonMode.VANILLA);
        }
    }
}