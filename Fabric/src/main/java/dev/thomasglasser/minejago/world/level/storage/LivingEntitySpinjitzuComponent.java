...
public class LivingEntitySpinjitzuComponent implements SpinjitzuComponent
{
    private boolean unlocked;
    private boolean active;

    public LivingEntitySpinjitzuComponent() {
        this(false, false);
    }

    public LivingEntitySpinjitzuComponent(boolean baseUnlocked, boolean baseActive)
    {
